...
def peptide_encodings( sequence_file, peptide_file, codon_table_file ):
	sequence = parse_sequence_file( sequence_file )
	peptide = parse_sequence_file( peptide_file )
...
if __name__ == '__main__':
	...
	codon_table_file = sys.argv[3]

	encodings = list(peptide_encodings( sequence_file, peptide_file, codon_table_file ))
	print(len(encodings))
